function [x_1, x_2] = pogm_LLR_split_sens(E_1, dd_1, E_2, dd_2, lambda, patch_size, im_size, niter)
...
for iter = 1:niter
    ...
    %   y-update
    y0_1  =   y_1;
    y_1   =   x_1 - (1/L_1)*(mtimes2_sens(E_1,x_1)-dd_1);
    ...
    %   y-update
    y0_2  =   y_2;
    y_2   =   x_2 - (1/L_2)*(mtimes2_sens(E_2,x_2)-dd_2);
