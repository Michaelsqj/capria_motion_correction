function [x1, x2] = pogm_LLR_mismatch_sens(E1, dd1, E2, dd2, lambda, patch_size, im_size, niter)
...
%-------------------------------------
    ...
    L_1   =   1/max_step_sens(E1, 10);
    L_2   =   1/max_step_sens(E2, 10);
    L   =   min(L_1, L_2);
    % L   =   3.0358e-10;
...
for iter = 1:niter
    ...
    y1   =   x1 - (1/L)*(mtimes2_sens(E1, x1)-dd1);
    y2   =   x2 - (1/L)*(mtimes2_sens(E2, x2)-dd2);
