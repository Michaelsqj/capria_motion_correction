...
paramfname="/vols/Data/okell/qijia/test_moco/cone_data_144_WE_motion2/subspace_param_stage2.m"
basname="/vols/Data/okell/qijia/test_moco/cone_data_144_WE_motion2/subspace_motion_stage2/subspace_repeat"
outname="/vols/Data/okell/qijia/test_moco/cone_data_144_WE_motion2/subspace_motion_stage2_combined"
rm recon_subspace_script1
for i in {1..98}
do
    SUBCMD="sim_invivo_motion('${paramfname}',[${i}])"
    echo $MATLABCMD \"$SUBCMD\" >> recon_subspace_script1
done

CMD="$FSLSUBCMD -q short.q -s openmp,4 -t recon_subspace_script1"
ID=$(eval $CMD)
