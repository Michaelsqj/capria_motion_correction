...
maskpath="${rootdir}/subspace_motion_stage1_brain_mask"
outmat="${rootdir}/subspace_motion_stage1_combined_masked_flirt_combined_brain.mat"
tmpmat="${rootdir}/subspace_motion_stage1_combined_masked_flirt_tmp_combined"
...
do
    ...
    SUBCMD="flirt -in ${inpath}/${movname} -ref ${inpath}/${refname} -out ${outpath}/${movname} -omat ${outmat}/${outname}\
